...
function jeg_register_theme_customizer($wp_customize) {
    ...
    locate_template(array('/lib/customizer/options/header.php'),    true, true);  #2
    locate_template(array('/lib/customizer/options/font.php'),      true, true);  #3
    locate_template(array('/lib/customizer/options/post.php'),      true, true);  #4
    locate_template(array('/lib/customizer/options/page.php'),      true, true);  #5
    locate_template(array('/lib/customizer/options/archives.php'),  true, true);  #6
    locate_template(array('/lib/customizer/options/socials.php'),   true, true);  #7
    locate_template(array('/lib/customizer/options/footer.php'),    true, true);  #8
    locate_template(array('/lib/customizer/options/customcss.php'), true, true);  #9
}
